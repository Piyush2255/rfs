...
urlpatterns = [
    ...
    path('allpostjobs',views.allpostjobs,name='allpostjobs'),
    path('selectmultiple',views.selectmultiple,name='selectmultiple'),
    path('selectmultipleusers',views.selectmultipleusers,name='selectmultipleusers'),
